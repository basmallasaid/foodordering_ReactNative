...
import {
  View, Text, TextInput, TouchableOpacity, StyleSheet, Alert, Dimensions, ScrollView,
  KeyboardAvoidingView, Platform, ActivityIndicator, StatusBar, Image, Linking
} from "react-native";
...
export default function RegisterScreen({ navigation }) {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      Alert.alert("Registration Failed", mapFirebaseError(error.code));
    } finally {
      setLoading(false);
    }
  };
